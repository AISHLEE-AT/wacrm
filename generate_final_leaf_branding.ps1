...
Write-Host "Processing Leaf Logo from $srcPath (W: $($srcImg.Width), H: $($srcImg.Height))"
...
# Crop square centered on leaf & soil
...
# Configure JPEG Encoder Quality = 92
...
$bmp.Dispose()
Write-Host "BRAND LEAF LOGO REPLACED AT ALL PATHS WITH BRAND-LEAF-LOGO.PNG!"
