...
export function getFoundationalClass1to2Syllabus(courseId: string, courseTitle: string): CourseFullSyllabus {
  ...
  const subjects: SyllabusSubject[] = [
    {
      subjectId: 'fnd_tamil',
      subjectName: 'à®¤à®®à®¿à®´à¯ (Tamil — à®‰à®¯à®¿à®°à¯, à®®à¯†à®¯à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯ & à®®à®´à®²à¯ˆà®¯à®°à¯ à®ªà®¾à®Ÿà®²à¯)',
      icon: '🔤',
      color: '#ec4899',
      totalChapters: 4,
      totalMicroTopics: 12,
      chapters: [
          ...
          subtopics: [
            {
              ...
              microTopics: [
                ...
                { id: 'fnd_t_2', title: 'à®†à®¯à¯à®¤ à®Žà®´à¯à®¤à¯à®¤à¯ (à®ƒ) — à®Žà®ƒà®•à¯, à®…à®ƒà®¤à¯ à®‰à®šà¯à®šà®°à®¿à®ªà¯à®ªà¯ & à®ªà®¯à®©à¯à®ªà®¾à®Ÿà¯', keyAxiom: 'à®†à®¯à¯à®¤ à®Žà®´à¯à®¤à¯à®¤à¯ à®šà¯Šà®²à¯à®²à®¿à®©à¯ à®‡à®Ÿà¯ˆà®¯à®¿à®²à¯ à®®à®Ÿà¯à®Ÿà¯à®®à¯‡ à®µà®°à¯à®®à¯ à®¤à®©à®¿à®¨à®¿à®²à¯ˆ à®Žà®´à¯à®¤à¯à®¤à¯' }
              ]
            }
          ],
          microTopics: [
        ...
        {
          chapterNumber: 2,
          chapterTitle: 'à®®à¯†à®¯à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯ (18) — à®µà®²à¯à®²à®¿à®©à®®à¯, à®®à¯†à®²à¯à®²à®¿à®©à®®à¯, à®‡à®Ÿà¯ˆà®¯à®¿à®©à®®à¯',
          ...
          subtopics: [
            {
              ...
              microTopics: [
                { id: 'fnd_t_3', title: 'à®µà®²à¯à®²à®¿à®©à®®à¯ (à®•à®šà®Ÿà®¤à®ªà®± — à®•à¯, à®šà¯, à®Ÿà¯, à®¤à¯, à®ªà¯, à®±à¯) à®‰à®šà¯à®šà®°à®¿à®ªà¯à®ªà¯', keyAxiom: 'à®µà®²à¯à®²à®¿à®©à®®à¯ à®µà®©à¯à®®à¯ˆà®¯à®¾à®© à®“à®šà¯ˆà®¯à¯à®Ÿà¯ˆà®¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯' },
          ...
          subtopics: [
            {
              ...
              microTopics: [
                { id: 'fnd_t_5', title: 'à®•à¯ + à®… = à®• à®µà®°à®¿à®šà¯ˆ à®®à¯à®¤à®²à¯ à®•à¯ + à®” = à®•à¯Œ à®µà®°à¯ˆ', keyAxiom: 'à®‰à®¯à®¿à®°à¯à®®à¯†à®¯à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯ à®®à¯Šà®¤à¯à®¤à®®à¯ 18 × 12 = 216 à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯' }
              ]
            }
          ],
          microTopics: [
          ...
          subtopics: [
            {
              ...
              microTopics: [
                { id: 'fnd_t_6', title: 'à®…à®±à®žà¯à®šà¯†à®¯ à®µà®¿à®°à¯à®®à¯à®ªà¯, à®†à®±à¯à®µà®¤à¯ à®šà®¿à®©à®®à¯, à®‡à®¯à®²à¯à®µà®¤à¯ à®•à®°à®µà¯‡à®²à¯ à®µà®¿à®³à®•à¯à®•à®®à¯', keyAxiom: 'à®†à®¤à¯à®¤à®¿à®šà¯‚à®Ÿà®¿ à®ªà®¾à®Ÿà®¿à®¯à®µà®°à¯ à®”à®µà¯ˆà®¯à®¾à®°à¯ — à®Žà®³à®¿à®¯ à®¨à®©à¯à®©à¯†à®±à®¿ à®¨à¯€à®¤à®¿ à®¨à¯‚à®²à¯' }
              ]
            }
          ],
          microTopics: [
            { id: 'fnd_t_6', topicTitle: 'à®”à®µà¯ˆà®¯à®¾à®°à¯ à®†à®¤à¯à®¤à®¿à®šà¯‚à®Ÿà®¿ (12 à®µà®°à®¿à®•à®³à¯ & à®¨à®¯à®µà¯à®°à¯ˆ)', subtopic: 'à®…à®±à®žà¯à®šà¯†à®¯ à®µà®¿à®°à¯à®®à¯à®ªà¯ — à®Žà®ªà¯à®ªà¯‹à®¤à¯à®®à¯ à®¨à®²à¯à®² à®šà¯†à®¯à®²à¯à®•à®³à¯ˆà®šà¯ à®šà¯†à®¯à¯', dayNumber: 10, periodNumber: 1, keyFormulaOrLaw: 'à®†à®¤à¯à®¤à®¿à®šà¯‚à®Ÿà®¿: "à®…à®±à®žà¯à®šà¯†à®¯ à®µà®¿à®°à¯à®®à¯à®ªà¯", "à®†à®±à¯à®µà®¤à¯ à®šà®¿à®©à®®à¯", "à®ˆà®¯à®¤à¯ à®µà®¿à®²à®•à¯à®•à¯‡à®²à¯"', keyPoints: ['à®”à®µà¯ˆà®¯à®¾à®°à¯ à®…à®°à¯à®³à®¿à®¯ à®¨à¯€à®¤à®¿ à®¨à¯†à®±à®¿à®®à¯à®±à¯ˆà®•à®³à¯ˆ à®…à®©à¯à®±à®¾à®Ÿ à®µà®¾à®´à¯à®µà®¿à®²à¯ à®•à®Ÿà¯ˆà®ªà¯à®ªà®¿à®Ÿà®¿à®¤à¯à®¤à®²à¯'], type: 'memorization', importance: 'High-Yield' }
          ]
        }
      ]
    },
    ...
    },
    {
      ...
      chapters: [
        {
          chapterNumber: 1,
          chapterTitle: isTa ? 'à®Žà®£à¯à®•à®³à¯, à®‡à®Ÿà®®à®¤à®¿à®ªà¯à®ªà¯ & à®•à¯‚à®Ÿà¯à®Ÿà®²à¯/à®•à®´à®¿à®¤à¯à®¤à®²à¯' : 'Numbers (1–100), Place Value & Addition/Subtraction',
        ...
        {
          chapterNumber: 2,
          chapterTitle: isTa ? 'à®ªà¯†à®°à¯à®•à¯à®•à®²à¯ à®µà®¾à®¯à¯à®ªà¯à®ªà®¾à®Ÿà¯à®•à®³à¯ (1–10) & à®¨à®¾à®£à®¯à®™à¯à®•à®³à¯' : 'Multiplication Tables (1–10) & Indian Currency',
          ...
          subtopics: [
            {
              ...
              microTopics: [
                { id: 'fnd_m_3', title: 'à®ªà¯†à®°à¯à®•à¯à®•à®²à¯ à®µà®¾à®¯à¯à®ªà¯à®ªà®¾à®Ÿà¯à®•à®³à¯ (2, 3, 4, 5, 10)', keyAxiom: 'Multiplication is repeated addition: 3 × 4 = 4 + 4 + 4 = 12' },
  ...
  const subjects: SyllabusSubject[] = [
    {
      ...
      subjectName: 'à®¤à®®à®¿à®´à¯ (Tamil — à®šà¯†à®¯à¯à®¯à¯à®³à¯, à®‰à®°à¯ˆà®¨à®Ÿà¯ˆ, à®¤à¯à®£à¯ˆà®ªà¯à®ªà®¾à®Ÿà®®à¯ & à®•à®±à¯à®•à®£à¯à®Ÿà¯ à®‡à®²à®•à¯à®•à®£à®®à¯)',
      icon: '🔤',
      color: '#ec4899',
      totalChapters: 4,
      totalMicroTopics: 14,
      chapters: [
          ...
          subtopics: [
            {
              ...
              microTopics: [
                { id: 'prep_t_1', title: 'à®¤à®®à®¿à®´à¯à®•à¯à®•à¯à®®à¯ à®…à®®à¯à®¤à¯†à®©à¯à®±à¯ à®ªà¯‡à®°à¯ — à®ªà®¾à®°à®¤à®¿à®¤à®¾à®šà®©à¯ à®•à®µà®¿à®¤à¯ˆ à®¨à®¯à®®à¯', keyAxiom: 'à®¤à®®à®¿à®´à¯ˆ à®‰à®¯à®¿à®°à¯à®•à¯à®•à¯ à®¨à¯‡à®°à®¾à®•à®ªà¯ à®ªà¯‹à®±à¯à®±à®¿à®¯ à®ªà¯à®°à®Ÿà¯à®šà®¿à®•à¯ à®•à®µà®¿à®žà®°à¯ à®ªà®¾à®°à®¤à®¿à®¤à®¾à®šà®©à¯' },
                { id: 'prep_t_2', title: 'à®”à®µà¯ˆà®¯à®¾à®°à¯ à®®à¯‚à®¤à¯à®°à¯ˆ — à®¨à®²à¯à®²à¯‹à®°à¯ à®¨à®Ÿà¯à®ªà®¿à®©à¯ à®šà®¿à®±à®ªà¯à®ªà¯ & à®®à®©à®ªà¯à®ªà®¾à®Ÿà®ªà¯ à®ªà®•à¯à®¤à®¿', keyAxiom: '"à®…à®Ÿà¯à®Ÿà®¾à®²à¯à®®à¯ à®ªà®¾à®²à¯à®šà¯à®µà¯ˆà®¯à®¿à®²à¯ à®•à¯à®©à¯à®±à®¾à®¤à¯" — à®…à®±à®¿à®žà®°à¯à®•à®³à¯ à®µà®±à¯à®®à¯ˆà®¯à®¿à®²à¯à®®à¯ à®¨à®±à¯à®ªà®£à¯à®ªà¯ à®¤à®µà®±à®¾à®°à¯' }
              ]
            }
          ],
          microTopics: [
          ...
          subtopics: [
            {
              ...
              microTopics: [
                ...
                { id: 'prep_t_4', title: 'à®•à®¾à®®à®°à®¾à®šà®°à®¿à®©à¯ à®•à®²à¯à®µà®¿à®ªà¯ à®ªà®£à®¿à®•à®³à¯ — à®‡à®²à®µà®šà®•à¯ à®•à®²à¯à®µà®¿ & à®®à®¤à®¿à®¯ à®‰à®£à®µà¯', keyAxiom: 'à®ªà®Ÿà¯à®Ÿà®¿à®¤à¯Šà®Ÿà¯à®Ÿà®¿à®¯à¯†à®™à¯à®•à¯à®®à¯ à®ªà®³à¯à®³à®¿à®•à®³à¯ à®¤à®¿à®±à®¨à¯à®¤à¯ à®•à®²à¯à®µà®¿à®•à¯à®•à®£à¯ à®¤à®¿à®±à®¨à¯à®¤ à®ªà¯†à®°à¯à®¨à¯à®¤à®²à¯ˆà®µà®°à¯ à®•à®¾à®®à®°à®¾à®šà®°à¯' }
              ]
            }
          ],
          microTopics: [
        ...
        },
        {
          ...
          microTopics: [
            { id: 'prep_t_5', topicTitle: 'à®¤à¯à®£à¯ˆà®ªà¯à®ªà®¾à®Ÿà®•à¯ à®•à®¤à¯ˆà®•à®³à¯ — à®šà®®à®¯à¯‹à®šà®¿à®¤ à®ªà¯à®¤à¯à®¤à®¿ & à®¤à®²à¯ˆà®®à¯ˆà®¤à¯à®¤à¯à®µà®®à¯', subtopic: 'à®®à¯à®¯à®²à¯ à®šà¯Šà®©à¯à®© à®•à®¤à¯ˆ à®®à®±à¯à®±à¯à®®à¯ à®¤à®²à¯ˆà®®à¯ˆà®ªà¯ à®ªà®£à¯à®ªà¯ à®ªà®Ÿà®¿à®ªà¯à®ªà®¿à®©à¯ˆà®•à®³à¯', dayNumber: 7, periodNumber: 1, keyFormulaOrLaw: 'à®¨à¯€à®¤à®¿: "à®…à®±à®¿à®µà¯‡ à®†à®±à¯à®±à®²à¯" — à®¤à¯à®©à¯à®ªà®®à¯ à®µà®°à¯à®®à¯ à®µà¯‡à®³à¯ˆà®¯à®¿à®²à¯ à®…à®±à®¿à®µà¯à®•à¯à®•à¯‚à®°à¯à®®à¯ˆà®¯à¯à®Ÿà®©à¯ à®šà¯†à®¯à®²à¯à®ªà®Ÿ à®µà¯‡à®£à¯à®Ÿà¯à®®à¯', keyPoints: ['à®•à®¤à¯ˆà®¯à®¿à®©à¯ à®®à¯ˆà®¯à®•à¯ à®•à®°à¯à®¤à¯à®¤à¯ˆ à®‰à®£à®°à¯à®¨à¯à®¤à¯ à®šà¯Šà®¨à¯à®¤ à®¨à®Ÿà¯ˆà®¯à®¿à®²à¯ à®µà®¿à®µà®°à®¿à®¤à¯à®¤à®²à¯'], type: 'concept', importance: 'Foundational' }
          ]
        },
        {
          chapterNumber: 4,
      ...
      chapters: [
        {
          ...
          description: isTa ? '5–6 à®‡à®²à®•à¯à®• à®Žà®£à¯à®•à®³à¯, à®ªà®•à®¾ à®Žà®£à¯à®•à®³à¯, à®®à¯€.à®šà®¿.à®® & à®®à¯€.à®ªà¯Š.à®µ, à®‰à®°à¯‹à®®à®¾à®©à®¿à®¯ à®Žà®£à¯à®•à®³à¯' : '5 to 6-digit operations, Prime & Composite numbers, HCF & LCM, Roman Numerals',
          subtopics: [
            {
              id: 'prep_m_sub1',
              title: 'à®Žà®£à¯à®•à®£à®¿à®¤à®®à¯ & HCF/LCM',
              microTopics: [
                { id: 'prep_m_1', title: 'à®ªà®•à®¾ à®Žà®£à¯à®•à®³à¯ & à®®à¯€à®ªà¯à®ªà¯†à®°à¯ à®ªà¯Šà®¤à¯ à®•à®¾à®°à®£à®¿ (HCF / LCM)', keyAxiom: 'Product of Two Numbers = HCF × LCM' },
          ...
          microTopics: [
            { id: 'prep_m_1', topicTitle: isTa ? 'à®ªà®•à®¾ à®Žà®£à¯à®•à®³à¯ & à®ªà®•à®¾ à®•à®¾à®°à®£à®¿à®ªà¯à®ªà®Ÿà¯à®¤à¯à®¤à¯à®¤à®²à¯ (HCF / LCM)' : 'Prime Factorization, HCF & LCM Fundamentals', subtopic: isTa ? 'à®®à¯€à®ªà¯à®ªà¯†à®°à¯ à®ªà¯Šà®¤à¯ à®•à®¾à®°à®£à®¿ à®®à®±à¯à®±à¯à®®à¯ à®®à¯€à®šà¯à®šà®¿à®±à¯ à®ªà¯Šà®¤à¯ à®®à®Ÿà®™à¯à®•à¯' : 'Factor tree method, division method, Product = HCF × LCM formula', dayNumber: 3, periodNumber: 3, keyFormulaOrLaw: 'Product of Two Numbers = HCF × LCM | Prime Numbers have exactly 2 factors (1 and itself)', keyPoints: ['2 is the only even prime number', 'Co-prime numbers have HCF = 1'], type: 'solved_problem', importance: 'High-Yield' }
          ]
        },
        {
          chapterNumber: 2,
          ...
          microTopics: [
            { id: 'prep_m_3', topicTitle: isTa ? 'à®¨à¯‡à®°à¯à®µà¯€à®¤ à®®à¯à®±à¯ˆ & à®Žà®³à®¿à®¯ à®µà®¿à®´à¯à®•à¯à®•à®¾à®Ÿà¯ à®•à®£à®•à¯à®•à¯€à®Ÿà¯' : 'Unitary Method & Basic Percentages', subtopic: isTa ? 'à®…à®Ÿà®•à¯à®• à®µà®¿à®²à¯ˆ, à®µà®¿à®±à¯à®± à®µà®¿à®²à¯ˆ à®®à®±à¯à®±à¯à®®à¯ à®‡à®²à®¾à®ª à®¨à®Ÿà¯à®Ÿà®®à¯' : 'Find cost of 1 unit -> Multiply by desired quantity; % = (Value/Total) × 100', dayNumber: 6, periodNumber: 3, keyFormulaOrLaw: 'Unitary Rule: Unit Cost = Total Cost / Total Units | Profit = SP - CP (if SP > CP)', keyPoints: ['Profit% = (Profit / CP) × 100', 'Discount = Marked Price - Selling Price'], type: 'solved_problem', importance: 'High-Yield' }
          ]
        },
        {
          chapterNumber: 3,
          ...
          description: isTa ? 'à®šà¯†à®™à¯à®•à¯‹à®£à®®à¯, à®•à¯à®±à¯à®™à¯à®•à¯‹à®£à®®à¯, à®µà®¿à®°à®¿à®•à¯‹à®£à®®à¯, à®šà¯†à®µà¯à®µà®•à®®à¯/à®šà®¤à¯à®°à®®à¯ à®šà¯à®±à¯à®±à®³à®µà¯' : 'Acute, Right, Obtuse angles; Perimeter = Sum of all sides; Area of Rectangle = l × w',
          subtopics: [
            {
              id: 'prep_m_sub3',
              title: 'à®µà®Ÿà®¿à®µà®¿à®¯à®²à¯ & à®…à®³à®µà®¿à®¯à®²à¯',
              microTopics: [
                { id: 'prep_m_4', title: 'à®•à¯‹à®£à®™à¯à®•à®³à®¿à®©à¯ à®µà®•à¯ˆà®•à®³à¯ & à®šà¯à®±à¯à®±à®³à®µà¯ à®ªà®°à®ªà¯à®ªà®³à®µà¯ à®šà¯‚à®¤à¯à®¤à®¿à®°à®™à¯à®•à®³à¯', keyAxiom: 'Rectangle: P = 2(l+w), A = l×w | Square: P = 4a, A = a²' }
              ]
            }
          ],
          microTopics: [
            { id: 'prep_m_4', topicTitle: isTa ? 'à®µà®Ÿà®¿à®µà®¿à®¯à®²à¯: à®•à¯‹à®£à®™à¯à®•à®³à¯ & à®ªà®°à®ªà¯à®ªà®³à®µà¯ / à®šà¯à®±à¯à®±à®³à®µà¯' : 'Geometry: Angles, Perimeter & Area', subtopic: isTa ? 'à®šà¯†à®™à¯à®•à¯‹à®£à®®à¯, à®•à¯à®±à¯à®™à¯à®•à¯‹à®£à®®à¯, à®µà®¿à®°à®¿à®•à¯‹à®£à®®à¯, à®šà¯†à®µà¯à®µà®•à®®à¯/à®šà®¤à¯à®°à®®à¯ à®šà¯à®±à¯à®±à®³à®µà¯' : 'Acute, Right, Obtuse angles; Perimeter = Sum of all sides; Area of Rectangle = l × w', dayNumber: 9, periodNumber: 3, keyFormulaOrLaw: 'Rectangle: Perimeter = 2(l + w), Area = l × w | Square: Perimeter = 4a, Area = a²', keyPoints: ['Right angle = 90°, Straight angle = 180°', 'Sum of angles in a triangle = 180°'], type: 'solved_problem', importance: 'High-Yield' }
          ]
        }
      ]
    },
          ...
          subtopics: [
            {
              ...
              microTopics: [
                { id: 'prep_s_3', title: 'à®¨à¯†à®®à¯à®ªà¯à®•à¯‹à®²à¯ (Levers) 3 à®µà®•à¯ˆà®•à®³à¯ & à®¤à®¤à¯à®¤à¯à®µà®®à¯', keyAxiom: 'Load × Load Arm = Effort × Effort Arm' }
              ]
            }
          ],
          microTopics: [
...
export function getMiddleClass6to8Syllabus(courseId: string, courseTitle: string): CourseFullSyllabus {
  ...
  const subjects: SyllabusSubject[] = [
    {
      subjectId: 'mid_tamil',
      subjectName: 'à®¤à®®à®¿à®´à¯ (Tamil — à®šà®®à®šà¯à®šà¯€à®°à¯ à®•à®²à¯à®µà®¿ 9 à®‡à®¯à®²à¯à®•à®³à¯ à®®à¯à®´à¯à®ªà¯ à®ªà®¾à®Ÿà®¤à¯à®¤à®¿à®Ÿà¯à®Ÿà®®à¯)',
      icon: '🔤',
      color: '#ec4899',
      totalChapters: 3,
      totalMicroTopics: 17,
      chapters: [
        {
          chapterNumber: 1,
          chapterTitle: 'à®¤à®®à®¿à®´à¯ à®¨à®¾à®©à¯‹ à®…à®²à®•à¯à®•à®³à¯: à®‰à®¯à®¿à®°à¯, à®®à¯†à®¯à¯, à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ & à®†à®¯à¯à®¤à®®à¯ (Days 41–46)',
          ...
          subtopics: [
            {
              ...
              microTopics: [
                { id: 'mid_t_41', title: 'à®‰à®¯à®¿à®°à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯: 5 à®•à¯à®±à®¿à®²à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯ (1 à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ) (Day 41)', keyAxiom: 'à®…, à®‡, à®‰, à®Ž, à®’ — à®•à¯à®±à¯à®•à®¿à®¯ à®“à®šà¯ˆà®¯à¯à®Ÿà¯ˆà®¯ 5 à®‰à®¯à®¿à®°à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯' },
                { id: 'mid_t_42', title: 'à®‰à®¯à®¿à®°à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯: 7 à®¨à¯†à®Ÿà®¿à®²à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯ (2 à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ) (Day 42)', keyAxiom: 'à®†, à®ˆ, à®Š, à®, à®, à®“, à®” — à®¨à¯€à®£à¯à®Ÿ à®“à®šà¯ˆà®¯à¯à®Ÿà¯ˆà®¯ 7 à®‰à®¯à®¿à®°à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯' },
                { id: 'mid_t_43', title: 'à®µà®²à¯à®²à®¿à®© à®®à¯†à®¯à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯: à®•à®šà®Ÿà®¤à®ªà®± (Day 43)', keyAxiom: 'à®•à¯, à®šà¯, à®Ÿà¯, à®¤à¯, à®ªà¯, à®±à¯ — à®µà®©à¯à®®à¯ˆà®¯à®¾à®© à®“à®šà¯ˆà®¯à¯à®Ÿà¯ˆà®¯ 6 à®®à¯†à®¯à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯' },
                { id: 'mid_t_44', title: 'à®®à¯†à®²à¯à®²à®¿à®© à®®à¯†à®¯à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯: à®™à®žà®£à®¨à®®à®© (Day 44)', keyAxiom: 'à®™à¯, à®žà¯, à®£à¯, à®¨à¯, à®®à¯, à®©à¯ — à®®à¯†à®©à¯à®®à¯ˆà®¯à®¾à®© à®®à¯‚à®•à¯à®•à¯Šà®²à®¿à®¯à¯à®Ÿà¯ˆà®¯ 6 à®®à¯†à®¯à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯' },
                { id: 'mid_t_45', title: 'à®‡à®Ÿà¯ˆà®¯à®¿à®© à®®à¯†à®¯à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯: à®¯à®°à®²à®µà®´à®³ (Day 45)', keyAxiom: 'à®¯à¯, à®°à¯, à®²à¯, à®µà¯, à®´à¯, à®³à¯ — à®‡à®Ÿà¯ˆà®ªà¯à®ªà®Ÿà¯à®Ÿ à®“à®šà¯ˆà®¯à¯à®Ÿà¯ˆà®¯ 6 à®®à¯†à®¯à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯' },
          ...
          microTopics: [
            ...
            { id: 'mid_t_43', topicTitle: 'à®µà®²à¯à®²à®¿à®© à®®à¯†à®¯à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯: à®•à®šà®Ÿà®¤à®ªà®± (Day 43)', subtopic: 'à®µà®©à¯à®®à¯ˆà®¯à®¾à®© à®“à®šà¯ˆà®¯à¯à®Ÿà¯ˆà®¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯: à®•à¯, à®šà¯, à®Ÿà¯, à®¤à¯, à®ªà¯, à®±à¯ (à®…à®°à¯ˆ à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ)', dayNumber: 43, periodNumber: 1, keyFormulaOrLaw: 'à®µà®²à¯à®²à®¿à®©à®®à¯ = à®•à¯, à®šà¯, à®Ÿà¯, à®¤à¯, à®ªà¯, à®±à¯ | à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ à®…à®³à®µà¯ = ½ à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ', keyPoints: ['à®®à®¾à®°à¯à®ªà¯ˆà®¤à¯ à®¤à®²à¯ˆà®®à¯ˆà®¯à®¾à®•à®•à¯ à®•à¯Šà®£à¯à®Ÿà¯ à®ªà®¿à®±à®•à¯à®•à¯à®®à¯ à®µà®©à¯à®®à¯ˆà®¯à®¾à®© à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯', 'à®šà¯Šà®²à¯à®²à®¿à®©à¯ à®‡à®±à¯à®¤à®¿à®¯à®¿à®²à¯ à®Ÿà¯, à®¤à¯, à®ªà¯ à®ªà¯‹à®©à¯à®± à®šà®¿à®² à®µà®²à¯à®²à®¿à®© à®®à¯†à®¯à¯à®•à®³à¯ à®µà®¾à®°à®¾'], type: 'concept', importance: 'High-Yield' },
            { id: 'mid_t_44', topicTitle: 'à®®à¯†à®²à¯à®²à®¿à®© à®®à¯†à®¯à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯: à®™à®žà®£à®¨à®®à®© (Day 44)', subtopic: 'à®®à¯†à®©à¯à®®à¯ˆà®¯à®¾à®© à®“à®šà¯ˆà®¯à¯à®Ÿà¯ˆà®¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯: à®™à¯, à®žà¯, à®£à¯, à®¨à¯, à®®à¯, à®©à¯ (à®…à®°à¯ˆ à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ)', dayNumber: 44, periodNumber: 1, keyFormulaOrLaw: 'à®®à¯†à®²à¯à®²à®¿à®©à®®à¯ = à®™à¯, à®žà¯, à®£à¯, à®¨à¯, à®®à¯, à®©à¯ | à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ à®…à®³à®µà¯ = ½ à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ', keyPoints: ['à®®à¯‚à®•à¯à®•à¯ˆà®¤à¯ à®¤à®²à¯ˆà®®à¯ˆà®¯à®¾à®•à®•à¯ à®•à¯Šà®£à¯à®Ÿà¯ à®ªà®¿à®±à®•à¯à®•à¯à®®à¯ à®®à¯†à®²à¯à®²à®¿à®¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯', 'à®µà®²à¯à®²à®¿à®© à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯à®•à¯à®•à¯ à®‡à®© à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à®¾à®• à®¨à®Ÿà¯à®ªà¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à®¾à®• à®…à®®à¯ˆà®•à®¿à®©à¯à®±à®© (à®™à¯-à®•à¯, à®žà¯-à®šà¯, à®£à¯-à®Ÿà¯, à®¨à¯-à®¤à¯, à®®à¯-à®ªà¯, à®©à¯-à®±à¯)'], type: 'concept', importance: 'High-Yield' },
            { id: 'mid_t_45', topicTitle: 'à®‡à®Ÿà¯ˆà®¯à®¿à®© à®®à¯†à®¯à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯: à®¯à®°à®²à®µà®´à®³ (Day 45)', subtopic: 'à®‡à®Ÿà¯ˆà®ªà¯à®ªà®Ÿà¯à®Ÿ à®“à®šà¯ˆà®¯à¯à®Ÿà¯ˆà®¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯: à®¯à¯, à®°à¯, à®²à¯, à®µà¯, à®´à¯, à®³à¯ (à®…à®°à¯ˆ à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ)', dayNumber: 45, periodNumber: 1, keyFormulaOrLaw: 'à®‡à®Ÿà¯ˆà®¯à®¿à®©à®®à¯ = à®¯à¯, à®°à¯, à®²à¯, à®µà¯, à®´à¯, à®³à¯ | à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ à®…à®³à®µà¯ = ½ à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ', keyPoints: ['à®•à®´à¯à®¤à¯à®¤à¯ˆà®¤à¯ à®¤à®²à¯ˆà®®à¯ˆà®¯à®¾à®•à®•à¯ à®•à¯Šà®£à¯à®Ÿà¯ à®µà®©à¯à®®à¯ˆà®•à¯à®•à¯à®®à¯ à®®à¯†à®©à¯à®®à¯ˆà®•à¯à®•à¯à®®à¯ à®‡à®Ÿà¯ˆà®ªà¯à®ªà®Ÿà¯à®Ÿà¯ à®ªà®¿à®±à®•à¯à®•à®¿à®©à¯à®±à®©', 'à®¤à®®à®¿à®´à¯ à®®à¯Šà®´à®¿à®•à¯à®•à¯‡ à®šà®¿à®±à®ªà¯à®ªà®¾à®© "à®´à¯" (à®šà®¿à®±à®ªà¯à®ªà¯ à®´à®•à®°à®®à¯) à®‡à®Ÿà¯ˆà®¯à®¿à®© à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à®¿à®²à¯ à®’à®©à¯à®±à®¾à®•à¯à®®à¯'], type: 'concept', importance: 'High-Yield' },
            { id: 'mid_t_46', topicTitle: 'à®†à®¯à¯à®¤ à®Žà®´à¯à®¤à¯à®¤à¯ (à®ƒ) à®ªà®¯à®©à¯à®ªà®¾à®Ÿà¯à®Ÿà¯ à®µà®¿à®¤à®¿à®•à®³à¯ (Day 46)', subtopic: 'à®®à¯à®ªà¯à®ªà¯à®³à¯à®³à®¿, à®®à¯à®ªà¯à®ªà®¾à®±à¯à®ªà¯à®³à¯à®³à®¿, à®¤à®©à®¿à®¨à®¿à®²à¯ˆ (à®…à®°à¯ˆ à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ)', dayNumber: 46, periodNumber: 1, keyFormulaOrLaw: 'à®†à®¯à¯à®¤à®®à¯ = à®ƒ | à®®à®¾à®¤à¯à®¤à®¿à®°à¯ˆ = ½ | à®µà®¿à®¤à®¿: à®¤à®©à®•à¯à®•à¯ à®®à¯à®©à¯ à®’à®°à¯ à®•à¯à®±à®¿à®²à¯ˆà®¯à¯à®®à¯ à®ªà®¿à®©à¯ à®’à®°à¯ à®µà®²à¯à®²à®¿à®© à®‰à®¯à®¿à®°à¯à®®à¯†à®¯à¯à®¯à¯ˆà®¯à¯à®®à¯ à®ªà¯†à®±à¯à®®à¯', keyPoints: ['à®šà¯Šà®²à¯à®²à®¿à®©à¯ à®®à¯à®¤à®²à®¿à®²à¯‹ à®‡à®±à¯à®¤à®¿à®¯à®¿à®²à¯‹ à®µà®°à®¾à®¤à¯; à®šà¯Šà®²à¯à®²à®¿à®©à¯ à®‡à®Ÿà¯ˆà®¯à®¿à®²à¯ à®®à®Ÿà¯à®Ÿà¯à®®à¯‡ à®µà®°à¯à®®à¯ (à®Ž.à®•à®¾: à®Žà®ƒà®•à¯, à®…à®ƒà®¤à¯, à®‡à®ƒà®¤à¯)', 'à®†à®¯à¯à®¤ à®Žà®´à¯à®¤à¯à®¤à¯ˆ à®®à¯à®¤à®©à¯à®®à¯ˆà®¯à®¾à®•à®•à¯ à®•à¯Šà®£à¯à®Ÿ à®šà¯Šà®²à¯ à®¤à®©à®¿à®¨à®¿à®²à¯ˆà®šà¯ à®šà¯Šà®²à¯ à®Žà®©à®ªà¯à®ªà®Ÿà¯à®®à¯'], type: 'concept', importance: 'High-Yield' }
          ]
        },
        {
          chapterNumber: 2,
          chapterTitle: 'à®¤à®®à®¿à®´à¯ à®¨à®¾à®©à¯‹ à®…à®²à®•à¯à®•à®³à¯: à®¤à®¿à®£à¯ˆ, à®ªà®¾à®²à¯ & à®®à¯à®•à¯à®•à®¾à®²à®®à¯ (Days 47–51)',
        ...
        {
          chapterNumber: 3,
          chapterTitle: 'à®¤à®®à®¿à®´à¯ à®¨à®¾à®©à¯‹ à®…à®²à®•à¯à®•à®³à¯: à®¤à¯Šà®•à¯ˆà®¨à®¿à®²à¯ˆà®¤à¯ à®¤à¯Šà®Ÿà®°à¯à®•à®³à¯ & à®ªà¯à®£à®°à¯à®šà¯à®šà®¿ (Days 52–57)',
    ...
    },
    {
      ...
      chapters: [
        ...
        },
        {
          ...
          description: isTa ? 'à®ªà®¿à®¤à®¾à®•à®°à®¸à¯ à®¤à¯‡à®±à¯à®±à®®à¯, à®®à¯à®•à¯à®•à¯‹à®£ à®µà®¿à®•à®¿à®¤à®™à¯à®•à®³à¯, à®µà®Ÿà¯à®Ÿà®¤à¯à®¤à®¿à®©à¯ à®šà¯à®±à¯à®±à®³à®µà¯ 2Ï€r à®®à®±à¯à®±à¯à®®à¯ à®ªà®°à®ªà¯à®ªà®³à®µà¯ Ï€r²' : 'Pythagorean theorem, Pythagorean triplets, Circle circumference (2Ï€r) and Circle area (Ï€r²)',
          subtopics: [
            {
              id: 'mid_m_sub3',
              title: 'à®µà®Ÿà®¿à®µà®¿à®¯à®²à¯ & à®…à®³à®µà®¿à®¯à®²à¯',
    ...
    },
    {
      ...
      chapters: [
        ...
        },
        {
          ...
          description: isTa ? 'à®²à®¿à®Ÿà¯à®®à®¸à¯, à®¨à®Ÿà¯à®¨à®¿à®²à¯ˆà®¯à®¾à®•à¯à®•à®²à¯, pH à®…à®³à®µà¯€à®Ÿà¯ (0–14), à®ªà¯à®°à¯‹à®Ÿà¯à®Ÿà®¾à®©à¯, à®Žà®²à®•à¯à®Ÿà¯à®°à®¾à®©à¯, à®¨à®¿à®¯à¯‚à®Ÿà¯à®°à®¾à®©à¯, à®…à®£à¯ à®Žà®£à¯ Z à®®à®±à¯à®±à¯à®®à¯ à®¨à®¿à®±à¯ˆ à®Žà®£à¯ A' : 'Litmus indicators, Neutralization, pH scale (0 to 14), Subatomic particles, Atomic number Z and Mass number A',
          subtopics: [
            {
              id: 'mid_s_sub2',
...
export function getHigherSecondaryScienceCompleteSyllabus(courseId: string, courseTitle: string): CourseFullSyllabus {
  ...
  const physicsChapters: SyllabusChapter[] = [
    {
      ...
      microTopics: [
        { id: 'hsc_phy_1', topicTitle: isTa ? 'à®•à¯‚à®²à¯à®®à¯ à®µà®¿à®¤à®¿, à®•à®¾à®¸à¯ à®µà®¿à®¤à®¿ & à®®à®¿à®©à¯à®ªà¯à®²à®®à¯' : 'Coulomb Law, Electric Field & Gauss Theorem Applications', subtopic: isTa ? 'F = (1/4Ï€Îµâ‚€)(qâ‚qâ‚‚/r²) à®®à®±à¯à®±à¯à®®à¯ à®•à®¾à®¸à¯ à®šà®®à®©à¯à®ªà®¾à®Ÿà¯à®•à®³à¯' : 'Electric dipole, Torque Ï„ = p × E, Flux Î¦ = âˆ® E·dA = q_enc / Îµâ‚€, Infinite line charge E = λ / (2Ï€Îµâ‚€r)', dayNumber: 1, periodNumber: 1, keyFormulaOrLaw: 'Coulomb: F = (1/4Ï€Îµâ‚€)(qâ‚qâ‚‚/r²) | Gauss: âˆ® E·dA = q_in / Îµâ‚€ | Dipole Potential V = (1/4Ï€Îµâ‚€)(p cos θ / r²)', keyPoints: ['Electric field inside a hollow spherical conductor is zero (Electrostatic shielding)', 'Capacitance of parallel plate with dielectric: C = K Îµâ‚€ A / d'], type: 'solved_problem', importance: 'High-Yield' },
        { id: 'hsc_phy_2', topicTitle: isTa ? 'à®•à®¿à®°à¯à®•à¯à®•à®¾à®ƒà®ªà¯ à®µà®¿à®¤à®¿à®•à®³à¯, à®µà¯€à®Ÿà¯à®¸à¯à®Ÿà¯‹à®©à¯ à®ªà®¾à®²à®®à¯ & à®®à®¿à®©à¯à®©à®´à¯à®¤à¯à®¤à®®à®¾à®©à®¿' : 'Kirchhoff Laws, Wheatstone Bridge & Drift Velocity', subtopic: isTa ? 'à®®à®¿à®©à¯à®©à¯‹à®Ÿà¯à®Ÿ à®µà®¿à®¤à®¿ (KCL), à®®à®¿à®©à¯à®©à®´à¯à®¤à¯à®¤ à®µà®¿à®¤à®¿ (KVL) & P/Q = R/S' : 'Current density j = n e v_d, Kirchhoff Current & Voltage Laws, Wheatstone balanced condition P/Q = R/S, Internal resistance r = R(lâ‚/lâ‚‚ - 1)', dayNumber: 5, periodNumber: 1, keyFormulaOrLaw: 'Kirchhoff Loop: Σ Î”V = 0 | Wheatstone: P/Q = R/S (Null deflection) | Drift Velocity v_d = eEÏ„ / m', keyPoints: ['KCL is based on conservation of charge; KVL is based on conservation of energy', 'Potentiometer draws no current at balance point, acting as an ideal voltmeter'], type: 'solved_problem', importance: 'High-Yield' }
      ]
    },
    {
      chapterNumber: 2,
      ...
      microTopics: [
        { id: 'hsc_phy_3', topicTitle: isTa ? 'à®ªà®¯à¯‹à®Ÿà¯-à®šà®¾à®µà®¾à®°à¯à®Ÿà¯ à®µà®¿à®¤à®¿, à®†à®®à¯à®ªà®¿à®¯à®°à¯ à®µà®¿à®¤à®¿ & à®²à®¾à®°à®©à¯à®¸à¯ à®µà®¿à®šà¯ˆ' : 'Biot-Savart Law, Ampere Circuital Law & Cyclotron Resonance', subtopic: isTa ? 'à®µà®Ÿà¯à®Ÿà®šà¯à®šà¯à®°à¯à®³à®¿à®©à¯ à®•à®¾à®¨à¯à®¤à®ªà¯à®ªà¯à®²à®®à¯ B = μâ‚€I/(2R) & F = q(v × B)' : 'Magnetic field on circular coil axis B = μâ‚€ I R² / [2(R²+x²)^(3/2)], Force on wire F = I(L × B), Galvanometer to Ammeter/Voltmeter conversion', dayNumber: 9, periodNumber: 1, keyFormulaOrLaw: 'Biot-Savart: dB = (μâ‚€/4Ï€)(I dl sin θ / r²) | Lorentz Force F = q(E + v × B) | Shunt Resistance S = I_g G / (I - I_g)', keyPoints: ['Parallel currents attract; antiparallel currents repel with force F/L = (μâ‚€ Iâ‚ Iâ‚‚) / (2Ï€d)', 'Converting Galvanometer to Ammeter requires low shunt resistance in parallel'], type: 'solved_problem', importance: 'High-Yield' },
        { id: 'hsc_phy_4', topicTitle: isTa ? 'à®®à®¿à®©à¯à®•à®¾à®¨à¯à®¤ à®¤à¯‚à®£à¯à®Ÿà®²à¯, LCR à®’à®¤à¯à®¤à®¤à®¿à®°à¯à®µà¯ & à®…à®²à¯ˆ à®’à®³à®¿à®¯à®¿à®¯à®²à¯ (YDSE)' : 'EMI (Faraday/Lenz), LCR Resonance & Young Double Slit (YDSE)', subtopic: isTa ? 'e = -dÎ¦/dt, à®’à®¤à¯à®¤à®¤à®¿à®°à¯à®µà¯ à®…à®¤à®¿à®°à¯à®µà¯†à®£à¯ f = 1/(2Ï€√LC), à®ªà®Ÿà¯à®Ÿà¯ˆà®¯à®¿à®©à¯ à®…à®•à®²à®®à¯ β = λD/d' : 'Motional EMF e = Bvl, Quality factor Q = (1/R)√(L/C), Wavefronts, Fringe width β = λD/d in interference, Brewster law μ = tan i_p', dayNumber: 13, periodNumber: 1, keyFormulaOrLaw: 'Faraday Law: e = -N (dÎ¦/dt) | LCR Resonance: f_r = 1 / (2Ï€√LC) | YDSE Fringe Width: β = λ D / d', keyPoints: ['Lenz law is consistent with principle of conservation of energy', 'Diffraction central maximum angular width θ = 2λ / a'], type: 'solved_problem', importance: 'High-Yield' }
      ]
    }
  ];
  ...
  const chemistryChapters: SyllabusChapter[] = [
    {
      ...
      microTopics: [
        { id: 'hsc_ch_1', topicTitle: isTa ? 'à®°à®µà¯à®²à¯à®Ÿà¯ à®µà®¿à®¤à®¿, à®šà®µà¯à®µà¯‚à®Ÿà¯à®ªà®°à®µà®²à¯ à®…à®´à¯à®¤à¯à®¤à®®à¯ & à®µà®¾à®£à¯à®Ÿà¯ à®¹à®¾à®ƒà®ªà¯ à®•à®¾à®°à®£à®¿' : 'Raoult Law, Colligative Properties & Van\'t Hoff Factor (i)', subtopic: isTa ? 'Î”T_b = K_b m, Î”T_f = K_f m, Ï€ = iCRT à®šà®®à®©à¯à®ªà®¾à®Ÿà¯à®•à®³à¯' : 'Relative lowering of vapour pressure (p°-p)/p° = x_B, Elevation in boiling point, Depression in freezing point, Abnormal molar mass i = 1 + (n-1)α', dayNumber: 2, periodNumber: 2, keyFormulaOrLaw: 'Raoult Law: p_A = p°_A x_A | Osmotic Pressure: Ï€ = i C R T | Van\'t Hoff: i = Normal Molar Mass / Abnormal Molar Mass', keyPoints: ['Colligative properties depend only on number of solute particles, not on their identity', 'For association of molecules, i < 1; for dissociation (electrolytes), i > 1'], type: 'solved_problem', importance: 'High-Yield' },
        { id: 'hsc_ch_2', topicTitle: isTa ? 'à®®à®¿à®©à¯à®µà¯‡à®¤à®¿à®¯à®¿à®¯à®²à¯: à®¨à¯†à®°à¯à®©à¯à®¸à¯à®Ÿà¯ à®šà®®à®©à¯à®ªà®¾à®Ÿà¯ & à®®à¯à®¤à®²à¯ à®µà®•à¯ˆ à®µà®¿à®©à¯ˆ à®šà®®à®©à¯à®ªà®¾à®Ÿà¯' : 'Nernst Equation, Kohlrausch Law & Integrated Rate Equations', subtopic: isTa ? 'E_cell = E° - (0.0591/n)log Q, k = (2.303/t)log([Aâ‚€]/[A])' : 'Electrochemical cell EMF, Standard Hydrogen Electrode (SHE), Kohlrausch law of independent migration of ions, Half-life t_½ = 0.693 / k, Arrhenius equation', dayNumber: 6, periodNumber: 2, keyFormulaOrLaw: 'Nernst: E_cell = E°_cell - (0.0591/n) log Q | First Order Rate: k = (2.303/t) log([A]â‚€/[A]) | t_½ = 0.693 / k', keyPoints: ['Gibbs Free Energy and EMF relation: Î”G° = -n F E°_cell', 'Half-life of first-order reaction is completely independent of initial reactant concentration'], type: 'solved_problem', importance: 'High-Yield' }
      ]
    },
    {
      chapterNumber: 2,
  ...
  const mathematicsChapters: SyllabusChapter[] = [
    {
      ...
      description: isTa ? 'à®…à®£à®¿à®¯à®¿à®©à¯ à®¨à¯‡à®°à¯à®®à®¾à®±à¯ Aâ»¹ = (1/|A|)adj(A), à®¤à¯Šà®Ÿà®°à¯à®šà¯à®šà®¿ à®®à®±à¯à®±à¯à®®à¯ à®µà®•à¯ˆà®¯à®¿à®Ÿà¯à®¤à®²à¯, à®Žà®²à¯à®²à¯ˆà®•à®³à¯' : 'Matrix inversion, Cramer\'s Rule, Continuity & Differentiability, Chain rule, Maxima & Minima (Second derivative test)',
      microTopics: [
        { id: 'hsc_m_1', topicTitle: isTa ? 'à®…à®£à®¿à®•à®³à¯ & à®…à®£à®¿à®•à¯à®•à¯‹à®µà¯ˆà®•à®³à¯: à®¨à¯‡à®°à¯à®®à®¾à®±à¯ à®®à®±à¯à®±à¯à®®à¯ à®•à®¿à®°à®¾à®®à®°à®¿à®©à¯ à®µà®¿à®¤à®¿' : 'Matrices & Determinants: Inverse Aâ»¹ & System of Linear Equations', subtopic: isTa ? 'Aâ»¹ = (1/|A|) adj A à®®à®±à¯à®±à¯à®®à¯ AX = B à®¤à¯€à®°à¯à®µà¯ à®®à¯à®±à¯ˆ' : 'Properties of determinants, Adjoint of square matrix, Solution of non-homogeneous linear systems using matrix method and Cramer\'s rule', dayNumber: 3, periodNumber: 3, keyFormulaOrLaw: 'Matrix Inverse: Aâ»¹ = (1 / |A|) adj(A) | Product: A · adj(A) = |A| I_n | System: X = Aâ»¹ B', keyPoints: ['A square matrix A is invertible if and only if |A| ≠ 0 (Non-singular matrix)', '|adj(A)| = |A|^(n-1) for a matrix of order n'], type: 'solved_problem', importance: 'High-Yield' },
        { id: 'hsc_m_2', topicTitle: isTa ? 'à®µà®•à¯ˆ à®¨à¯à®£à¯à®•à®£à®¿à®¤à®®à¯: à®ªà¯†à®°à¯à®®à®®à¯ à®®à®±à¯à®±à¯à®®à¯ à®šà®¿à®±à¯à®®à®®à¯ (Maxima & Minima)' : 'Calculus: Derivatives, Mean Value Theorems & Maxima/Minima', subtopic: isTa ? 'dy/dx = 0 à®ªà¯à®³à¯à®³à®¿à®•à®³à¯, d²y/dx² à®šà¯‹à®¤à®©à¯ˆ à®®à®±à¯à®±à¯à®®à¯ à®¤à¯Šà®Ÿà®°à¯ à®ªà¯†à®°à¯à®•à¯à®•à®®à¯' : 'Rolle\'s & Lagrange\'s Mean Value Theorems, Tangents & Normals slope m = dy/dx, Critical points, Second derivative test for local maxima/minima', dayNumber: 7, periodNumber: 3, keyFormulaOrLaw: 'Maxima Condition: f\'(x) = 0 and f\'\'(x) < 0 | Minima Condition: f\'(x) = 0 and f\'\'(x) > 0 | Chain Rule: d/dx[f(g(x))] = f\'(g(x)) · g\'(x)', keyPoints: ['If f\'\'(x) = 0 at critical point, use higher derivative test or first derivative sign test', 'Slope of normal to curve at (xâ‚, yâ‚) is -1 / (dy/dx)_(xâ‚,yâ‚)'], type: 'solved_problem', importance: 'High-Yield' }
      ]
    },
    {
      chapterNumber: 2,
      ...
      microTopics: [
        ...
        { id: 'hsc_m_4', topicTitle: isTa ? 'à®¤à®¿à®šà¯ˆà®¯à®©à¯à®•à®³à¯ (Vectors), à®®à¯à®ªà¯à®ªà®°à®¿à®®à®¾à®£ à®µà®Ÿà®¿à®µà®¿à®¯à®²à¯ & à®ªà¯‡à®¯à®¸à¯ à®¤à¯‡à®±à¯à®±à®®à¯' : 'Vectors, 3D Geometry (Skew Lines) & Bayes Theorem', subtopic: isTa ? 'a · b = |a||b|cos θ, a × b, à®•à¯‹à®Ÿà¯à®•à®³à¯à®•à¯à®•à¯ à®‡à®Ÿà¯ˆà®ªà¯à®ªà®Ÿà¯à®Ÿ à®®à¯€à®šà¯à®šà®¿à®±à¯ à®¤à¯Šà®²à¯ˆà®µà¯, à®¨à®¿à®ªà®¨à¯à®¤à®©à¯ˆ à®¨à®¿à®•à®´à¯à®¤à®•à®µà¯' : 'Scalar triple product [a b c], Vector cross product, Shortest distance d = |(aâ‚‚-aâ‚)·(bâ‚×bâ‚‚)| / |bâ‚×bâ‚‚|, Conditional probability P(A|B), Bayes\' Theorem calculation', dayNumber: 15, periodNumber: 3, keyFormulaOrLaw: 'Dot Product: a · b = aâ‚bâ‚ + aâ‚‚bâ‚‚ + aâ‚ƒbâ‚ƒ | Cross Product: |a × b| = |a||b| sin θ | Bayes: P(A_i|B) = [P(A_i)P(B|A_i)] / Σ[P(A_j)P(B|A_j)]', keyPoints: ['Two non-zero vectors a and b are perpendicular if and only if a · b = 0', 'Shortest distance between two parallel lines r = aâ‚ + λb and r = aâ‚‚ + μb is |b × (aâ‚‚ - aâ‚)| / |b|'], type: 'solved_problem', importance: 'High-Yield' }
      ]
    }
  ];
      ...
      subtopics: [
        {
          ...
          microTopics: [
            { id: 'hsc_t_1', title: 'à®¤à®©à¯à®©à¯‡à®°à¯ à®‡à®²à®¾à®¤ à®¤à®®à®¿à®´à¯ (à®¤à®£à¯à®Ÿà®¿à®¯à®²à®™à¯à®•à®¾à®°à®®à¯) — à®šà¯†à®¨à¯à®¤à®®à®¿à®´à®¿à®©à¯ à®¤à®©à®¿à®šà¯à®šà®¿à®±à®ªà¯à®ªà¯', keyAxiom: 'à®“à®™à¯à®•à®²à®¿à®Ÿà¯ˆ à®µà®¨à¯à®¤à¯ à®‰à®¯à®°à¯à®¨à¯à®¤à¯‹à®°à¯ à®¤à¯Šà®´ à®µà®¿à®³à®™à¯à®•à®¿ à®à®™à¯à®•à¯Šà®²à®¿ à®¨à¯€à®°à¯ à®žà®¾à®²à®¤à¯à®¤à¯ à®‡à®°à¯à®³à®•à®±à¯à®±à¯à®®à¯ à®šà¯†à®¨à¯à®¤à®®à®¿à®´à¯' },
            { id: 'hsc_t_2', title: 'à®¤à®®à®¿à®´à®¾à®¯à¯ à®Žà®´à¯à®¤à¯à®µà¯‹à®®à¯ — à®µà®²à¯à®²à®¿à®©à®®à¯ à®®à®¿à®•à¯à®®à¯ à®‡à®Ÿà®™à¯à®•à®³à¯ & à®®à®¿à®•à®¾ à®‡à®Ÿà®™à¯à®•à®³à¯', keyAxiom: 'à®•à¯, à®šà¯, à®¤à¯, à®ªà¯ à®šà®¨à¯à®¤à®¿à®ªà¯à®ªà®¿à®´à¯ˆà®•à®³à¯ à®¨à¯€à®•à¯à®•à®¿ à®Žà®´à¯à®¤à¯à®¤à®²à¯' }
          ]
        }
      ],
      microTopics: [
      ...
      subtopics: [
        {
          ...
          microTopics: [
            { id: 'hsc_t_3', title: 'à®¤à®¿à®°à¯à®®à®²à¯ˆ à®®à¯à®°à¯à®•à®©à¯ à®ªà®³à¯à®³à¯ (à®ªà¯†à®°à®¿à®¯à®µà®©à¯ à®•à®µà®¿à®°à®¾à®¯à®°à¯) — à®‰à®´à®µà¯à®šà¯ à®šà®¿à®±à®ªà¯à®ªà¯', keyAxiom: 'à®ªà®³à¯à®³à¯ à®Žà®©à¯à®ªà®¤à¯ 96 à®µà®•à¯ˆ à®šà®¿à®±à¯à®±à®¿à®²à®•à¯à®•à®¿à®¯à®™à¯à®•à®³à¯à®³à¯ à®’à®©à¯à®±à¯ (à®‰à®´à®¤à¯à®¤à®¿à®ªà¯ à®ªà®¾à®Ÿà¯à®Ÿà¯)' },
            { id: 'hsc_t_4', title: 'à®à®™à¯à®•à¯à®±à¯à®¨à¯‚à®±à¯ (à®®à¯à®²à¯à®²à¯ˆà®¤à¯à®¤à®¿à®£à¯ˆ — à®ªà¯‡à®¯à®©à®¾à®°à¯) & à®¨à®¾à®²à¯à®µà®•à¯ˆà®ªà¯ à®ªà¯Šà®°à¯à®¤à¯à®¤à®™à¯à®•à®³à¯', keyAxiom: 'à®à®™à¯à®•à¯à®±à¯à®¨à¯‚à®±à¯ 3 à®…à®Ÿà®¿ à®®à¯à®¤à®²à¯ 6 à®…à®Ÿà®¿ à®µà®°à¯ˆà®¯à®¿à®²à®¾à®© à®•à¯à®±à¯ˆà®¨à¯à®¤ à®…à®•à®µà®±à¯à®ªà®¾à®•à¯à®•à®³à¯ à®•à¯Šà®£à¯à®Ÿ à®¨à¯‚à®²à¯' }
          ]
        }
      ],
      microTopics: [
  ...
  const subjects: SyllabusSubject[] = [
    { subjectId: 'hsc_tamil', subjectName: 'à®ªà¯Šà®¤à¯à®¤à¯ à®¤à®®à®¿à®´à¯ (General Tamil — HSC 8 à®‡à®¯à®²à¯à®•à®³à¯)', icon: '🔤', color: '#ec4899', totalChapters: generalTamilChapters.length, totalMicroTopics: generalTamilChapters.reduce((a, c) => a + (c.microTopics?.length || 0), 0), chapters: generalTamilChapters },
    ...
    { subjectId: 'hsc_physics', subjectName: isTa ? 'à®‡à®¯à®±à¯à®ªà®¿à®¯à®²à¯ (Physics Core — HSC / Board)' : 'Physics (Senior Secondary Core)', icon: '⚡', color: '#06b6d4', totalChapters: physicsChapters.length, totalMicroTopics: physicsChapters.reduce((a, c) => a + (c.microTopics?.length || 0), 0), chapters: physicsChapters },
    { subjectId: 'hsc_chemistry', subjectName: isTa ? 'à®µà¯‡à®¤à®¿à®¯à®¿à®¯à®²à¯ (Chemistry Core — HSC / Board)' : 'Chemistry (Senior Secondary Core)', icon: 'ðŸ§ª', color: '#10b981', totalChapters: chemistryChapters.length, totalMicroTopics: chemistryChapters.reduce((a, c) => a + (c.microTopics?.length || 0), 0), chapters: chemistryChapters },
    { subjectId: 'hsc_mathematics', subjectName: isTa ? 'à®•à®£à®¿à®¤à®®à¯ (Mathematics Core — HSC / Board)' : 'Mathematics (Senior Secondary Calculus & Vectors)', icon: 'ðŸ“', color: '#f59e0b', totalChapters: mathematicsChapters.length, totalMicroTopics: mathematicsChapters.reduce((a, c) => a + (c.microTopics?.length || 0), 0), chapters: mathematicsChapters }
  ];
...
export function getTamilNaduPoliceCompleteSyllabus(courseId?: string, courseTitle?: string): CourseFullSyllabus {
  const tamilEligibilityChapters: SyllabusChapter[] = [
    {
      chapterNumber: 1,
      chapterTitle: 'à®ªà®•à¯à®¤à®¿ à®…: à®¤à®®à®¿à®´à¯ à®‡à®²à®•à¯à®•à®£à®®à¯ (10à®†à®®à¯ à®µà®•à¯à®ªà¯à®ªà¯ à®¤à®°à®®à¯ — 100 à®µà®¿à®©à®¾à®•à¯à®•à®³à¯ à®¤à®•à¯à®¤à®¿)',
      ...
      subtopics: [
        {
          ...
          microTopics: [
            ...
            { id: 'pol_gk_2', title: 'à®…à®Ÿà®¿à®ªà¯à®ªà®Ÿà¯ˆ à®‰à®°à®¿à®®à¯ˆà®•à®³à¯ (14–32), à®•à¯à®Ÿà®¿à®¯à®°à®šà¯à®¤à¯ à®¤à®²à¯ˆà®µà®°à¯, à®†à®³à¯à®¨à®°à¯', keyAxiom: 'à®šà®°à®¤à¯à®¤à¯ 32 à®…à®°à®šà®¿à®¯à®²à®®à¯ˆà®ªà¯à®ªà®¿à®©à¯ à®‡à®¤à®¯à®®à¯ à®®à®±à¯à®±à¯à®®à¯ à®†à®©à¯à®®à®¾' }
          ]
        }
      ],
      microTopics: [
        { id: 'pol_gk_1', topicTitle: 'à®‡à®¨à¯à®¤à®¿à®¯ à®µà®¿à®Ÿà¯à®¤à®²à¯ˆ à®‡à®¯à®•à¯à®•à®®à¯, à®¤à®®à®¿à®´à®• à®ªà®™à¯à®•à¯ & à®…à®°à®šà®¿à®¯à®²à®®à¯ˆà®ªà¯à®ªà¯ à®…à®Ÿà®¿à®ªà¯à®ªà®Ÿà¯ˆ à®‰à®°à®¿à®®à¯ˆà®•à®³à¯', subtopic: 'à®µà¯‡à®²à¯à®¨à®¾à®šà¯à®šà®¿à®¯à®¾à®°à¯, à®µ.à®‰.à®šà®¿, à®ªà®•à®¤à¯à®šà®¿à®™à¯, à®•à®¾à®¨à¯à®¤à®¿à®¯à®Ÿà®¿à®•à®³à¯ à®®à®±à¯à®±à¯à®®à¯ à®šà®°à®¤à¯à®¤à¯ 14–32', dayNumber: 2, periodNumber: 2, keyFormulaOrLaw: 'à®…à®°à®šà®¿à®¯à®²à®®à¯ˆà®ªà¯à®ªà¯ à®¨à®Ÿà¯ˆà®®à¯à®±à¯ˆ: 26 à®œà®©à®µà®°à®¿ 1950 | à®šà®Ÿà¯à®Ÿà®¤à¯à®¤à®¿à®©à¯ à®®à¯à®©à¯ à®…à®©à¯ˆà®µà®°à¯à®®à¯ à®šà®®à®®à¯: à®šà®°à®¤à¯à®¤à¯ 14', keyPoints: ['à®¤à®®à®¿à®´à¯à®¨à®¾à®Ÿà¯ à®•à®¾à®µà®²à¯ à®¤à¯à®±à¯ˆ à®šà®¿à®©à¯à®©à®®à¯: à®¸à¯à®°à¯€à®µà®¿à®²à¯à®²à®¿à®ªà¯à®¤à¯à®¤à¯‚à®°à¯ à®•à¯‹à®µà®¿à®²à¯ à®•à¯‹à®ªà¯à®°à®®à¯', 'à®•à®¾à®µà®²à¯à®¤à¯à®±à¯ˆ à®…à®®à¯ˆà®ªà¯à®ªà®¿à®©à¯ à®¤à®¨à¯à®¤à¯ˆ à®Žà®© à®…à®´à¯ˆà®•à¯à®•à®ªà¯à®ªà®Ÿà¯à®ªà®µà®°à¯ à®•à®¾à®°à®©à¯à®µà®¾à®²à®¿à®¸à¯ à®ªà®¿à®°à®ªà¯'], type: 'concept', importance: 'High-Yield' }
      ]
    },
    {
      chapterNumber: 2,
  ...
  const psychologyChapters: SyllabusChapter[] = [
    {
      ...
      microTopics: [
        { id: 'pol_psy_1', topicTitle: 'à®Žà®£à¯ à®¤à¯Šà®Ÿà®°à¯, Coding-Decoding, à®‡à®°à®¤à¯à®¤ à®‰à®±à®µà¯à®•à®³à¯ & à®¤à®¿à®šà¯ˆ à®…à®±à®¿à®¤à®²à¯', subtopic: 'à®¤à®¿à®šà¯ˆ à®•à®£à®•à¯à®•à¯€à®Ÿà¯à®•à®³à¯, à®‰à®±à®µà¯à®®à¯à®±à¯ˆ à®µà®°à¯ˆà®ªà®Ÿà®®à¯ à®®à®±à¯à®±à¯à®®à¯ à®µà®¿à®Ÿà¯à®ªà®Ÿà¯à®Ÿ à®Žà®£à¯ à®•à®£à¯à®Ÿà®±à®¿à®¤à®²à¯', dayNumber: 3, periodNumber: 3, keyFormulaOrLaw: 'à®¤à®¿à®šà¯ˆ à®¤à¯‚à®°à®®à¯ = √(à®µà®Ÿà®•à¯à®•à¯² + à®•à®¿à®´à®•à¯à®•à¯²) | à®•à¯à®±à®¿à®¯à¯€à®Ÿà¯à®Ÿà¯ à®®à¯à®±à¯ˆ: +1, -1, à®¤à®²à¯ˆà®•à¯€à®´à¯ à®Žà®´à¯à®¤à¯à®¤à¯à®•à®³à¯', keyPoints: ['à®‡à®°à®¤à¯à®¤ à®‰à®±à®µà¯à®•à®³à®¿à®²à¯ à®¤à®¨à¯à®¤à¯ˆ à®µà®´à®¿ vs à®¤à®¾à®¯à¯ à®µà®´à®¿ à®‰à®±à®µà¯à®®à¯à®±à¯ˆà®•à®³à¯ˆ à®¤à¯†à®³à®¿à®µà®¾à®• à®ªà®¿à®°à®¿à®•à¯à®•à®µà¯à®®à¯', 'à®•à®Ÿà®¿à®•à®¾à®° à®®à¯à®Ÿà¯à®•à®³à®¿à®©à¯ à®•à¯‹à®£à®®à¯: θ = |30H - (11/2)M|'], type: 'solved_problem', importance: 'High-Yield' }
      ]
    },
    {
      chapterNumber: 2,
      ...
      subtopics: [
        {
          ...
          microTopics: [
            ...
            { id: 'pol_psy_4', title: 'à®•à®¾à®²à®®à¯à®®à¯ à®µà¯‡à®²à¯ˆà®¯à¯à®®à¯ (Men × Days) & à®‡à®°à¯à®•à¯à®•à¯ˆ à®…à®®à¯ˆà®ªà¯à®ªà¯', keyAxiom: 'Mâ‚ Dâ‚ = Mâ‚‚ Dâ‚‚ à®šà¯‚à®¤à¯à®¤à®¿à®°à®®à¯' }
          ]
        }
      ],
      microTopics: [
  ...
  const subjects: SyllabusSubject[] = [
    { subjectId: 'pol_tamil', subjectName: 'à®¤à®®à®¿à®´à¯ à®®à¯Šà®´à®¿à®¤à¯ à®¤à®•à¯à®¤à®¿à®¤à¯ à®¤à¯‡à®°à¯à®µà¯ (Tamil Eligibility — 100 Marks)', icon: '🔤', color: '#ec4899', totalChapters: tamilEligibilityChapters.length, totalMicroTopics: tamilEligibilityChapters.reduce((a, c) => a + (c.microTopics?.length || 0), 0), chapters: tamilEligibilityChapters },
