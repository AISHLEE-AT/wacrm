...
export function resolveCompleteCourseSyllabus(
  ...
  // 6. SCHOOL K-12 STAGES (PRIORITIZED FOR 100% ACCURACY: HIGHER SEC -> SECONDARY -> MIDDLE -> PREP -> FOUNDATION)
  ...
  // 6b. Higher Secondary Stage (Classes 11 & 12 HSC Science, Commerce & Arts)
  const is12thOr11thHSC = (
    c.includes('11') || c.includes('12') ||
    ...
    title.includes('11-ஆம்') || title.includes('12-ஆம்') || title.includes('11 ஆம்') || title.includes('12 ஆம்') ||
    title.includes('வகுப்பு 11') || title.includes('வகுப்பு 12') ||
    cat.includes('school_hsc')
  );

  if (is12thOr11thHSC) {
    if (c.includes('com') || title.includes('வணிகவியல்') || title.includes('commerce') || title.includes('accountancy')) {
  ...
  // 6c. Secondary Stage (Classes 9 & 10 SSLC)
  const isSecondarySSLC = (
    c.includes('-10') || c.includes('-9') ||
    c.includes('std-10') || c.includes('std-9') ||
    c.includes('class-10') || c.includes('class-9') ||
    c.includes('sslc') ||
    title.includes('10th') || title.includes('9th') ||
    title.includes('10-ஆம்') || title.includes('9-ஆம்') ||
    title.includes('10 ஆம்') || title.includes('9 ஆம்') ||
    title.includes('வகுப்பு 10') || title.includes('வகுப்பு 9') ||
  ...
  const isMiddleStage = (
    ...
    title.includes('6th') || title.includes('7th') || title.includes('8th') ||
    title.includes('6-ஆம்') || title.includes('7-ஆம்') || title.includes('8-ஆம்') ||
    title.includes('6 ஆம்') || title.includes('7 ஆம்') || title.includes('8 ஆம்') ||
    title.includes('வகுப்பு 6') || title.includes('வகுப்பு 7') || title.includes('வகுப்பு 8') ||
  ...
  // 6e. Preparatory Stage (Classes 3, 4, 5)
  const isPrepStage = (
    c.includes('-3') || c.includes('-4') || c.includes('-5') ||
    ...
    title.includes('3rd') || title.includes('4th') || title.includes('5th') ||
    title.includes('3-ஆம்') || title.includes('4-ஆம்') || title.includes('5-ஆம்') ||
    title.includes('3 ஆம்') || title.includes('4 ஆம்') || title.includes('5 ஆம்') ||
    title.includes('வகுப்பு 3') || title.includes('வகுப்பு 4') || title.includes('வகுப்பு 5')
  );
  ...
  // 6f. Foundational Stage (Classes 1 & 2)
  const isFoundationalStage = (
    c.includes('-1') || c.includes('-2') ||
    c.includes('std-1') || c.includes('std-2') ||
    c.includes('class-1') || c.includes('class-2') ||
    c.includes('class_1') || c.includes('class_2') ||
    title.includes('1st') || title.includes('2nd') ||
    title.includes('1-ஆம்') || title.includes('2-ஆம்') ||
    title.includes('1 ஆம்') || title.includes('2 ஆம்') ||
    title.includes('வகுப்பு 1') || title.includes('வகுப்பு 2')
  );

  if (isFoundationalStage) {
