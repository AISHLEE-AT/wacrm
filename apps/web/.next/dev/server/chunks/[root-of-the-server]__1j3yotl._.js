...
"[project]/apps/web/src/app/api/admin/driver-applications/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function supabaseAdmin() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(("TURBOPACK compile-time value", "https://gmahjdzqitbomtmdzlfp.supabase.co"), process.env.SUPABASE_SERVICE_ROLE_KEY);
}
async function GET() {
    try {
        const supabase = supabaseAdmin();
        // We fetch the applications and their corresponding user profiles to show names/emails
        const { data: applications, error } = await supabase.from('driver_applications').select('*').order('created_at', {
            ascending: false
        });
        if (error) {
        ...
        const { data: profiles, error: pError } = await supabase.from('profiles').select('user_id, full_name, email, account_id').in('user_id', userIds);
        if (pError) {
...
async function PATCH(request) {
    try {
        ...
        const { error: updateError } = await supabase.from('driver_applications').update({
            status
        }).eq('id', id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1j3yotl._.js.map