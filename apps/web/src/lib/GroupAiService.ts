...
<body>
  ...
  <div class="signature-grid">
    <div class="sign-box">
      ...
      <div class="sign-name">${meta.officers?.president || '(தலைவர் கையொப்பம்)'}</div>
    </div>
    <div class="sign-box">
      <div class="sign-line"></div>
      <div class="sign-role">செயலாளர் (Secretary)</div>
      <div class="sign-name">${meta.officers?.secretary || '(செயலாளர் கையொப்பம்)'}</div>
    </div>
    <div class="sign-box">
      <div class="sign-line"></div>
      <div class="sign-role">பொருளாளர் (Treasurer)</div>
      <div class="sign-name">${meta.officers?.treasurer || '(பொருளாளர் கையொப்பம்)'}</div>
    </div>
  </div>
