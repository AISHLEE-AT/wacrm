...
import { GraduationCap, PlayCircle, BookOpen, ExternalLink, ChevronDown, ChevronUp, X, Sparkles } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">Masterclass Courses, School & College Tuitions, & Skill Certification</p>
          </div>
        </div>
        ...
        <div className="flex items-center p-1 bg-slate-900 border border-slate-800 rounded-xl self-start md:self-auto">
          ...
          >
            ...
            Native Masterclasses ({courses.length})
          </button>
          <button
        ...
        <div className="space-y-6">
          {loading ? (
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-12 text-center max-w-lg mx-auto">
              ...
              <p className="text-slate-400 text-sm mt-1">Check back soon for upcoming masterclasses.</p>
            </div>
          ) : (
                  ...
                  >
                    <div>
                      <div className="relative h-48 w-full bg-slate-950 overflow-hidden">
                        ...
                        />
                        <div className="absolute top-3 left-3 bg-amber-500/90 backdrop-blur-md text-slate-950 font-extrabold text-[11px] px-2.5 py-1 rounded-full uppercase tracking-wider">
                    ...
                    <div className="p-5 pt-0 border-t border-slate-800/50 mt-4">
                      <button
                        ...
                        className="w-full mt-3 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold px-4 py-2.5 rounded-xl text-sm transition-all flex items-center justify-center gap-2 shadow-lg shadow-amber-500/10"
                      >
