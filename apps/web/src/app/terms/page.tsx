...
export const metadata = {
  title: 'Terms of Service | FAGO',
  description: 'Terms of Service for the FAGO application.',
};
    ...
    <div className="min-h-screen bg-background text-foreground py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl dark:prose-invert mx-auto">
          ...
          <p>
            FAGO provides tools for managing WhatsApp communications via the WhatsApp Business API, including shared inbox, contact management, sales pipelines, and automations. We reserve the right to modify or discontinue any part of the service at our discretion.
          </p>
          ...
          <p>
            In no event shall FAGO or its creators be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses resulting from your access to or use of our application.
          </p>
