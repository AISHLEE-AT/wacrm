...
VALUES
  ...
  (gen_random_uuid(), 'Kubota DC68G Paddy Harvester', 'Harvester', 'Captain Senthil Kumar', '6381029380', '6381029380', 'TN 38 HV 9988', 1800.0, '68 HP • Rubber Track Crawler • Paddy & Wheat', 5.0, true, true, 'available'),
  ...
  (gen_random_uuid(), 'JCB 3CX Heavy Excavator & Loader', 'JCB', 'Operator Velu', '6381029380', '6381029380', 'TN 38 JCB 1122', 1500.0, '76 HP Heavy Digging & Farm Leveling', 4.9, true, true, 'available')
