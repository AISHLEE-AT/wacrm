-- Migration 051: WhatsApp OTPs, Drivers Onboarding & System Integrity
-- Safe & idempotent script: can be executed repeatedly in Supabase SQL Editor

-- 1. Ensure whatsapp_otps table exists for Instant WhatsApp Login OTPs
...
-- 2. Ensure drivers table has all onboarding, verification, and live GPS location columns
...
-- 3. Ensure rides table has all transport & fare calculation columns
...
-- 4. Sync vehicle_number and vehicle_registration if one is filled
