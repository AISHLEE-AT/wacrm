...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM public.drivers WHERE is_verified = true) THEN
        ...
        VALUES 
          (gen_random_uuid(), 'Captain Senthil Kumar', '9486335870', '9486335870', 'Bike', 'TN 38 BL 9486', 'Honda Activa 6G', 'male', 4.9, 342, true, 'online', 11.0168, 76.9558, 'senthil@upi', NOW() + INTERVAL '30 days'),
